   ...
   implements ActionListener
{
   ...
   public GraphWindow(MainWindow mainWindow, int Typeoffile)
   {
   ...
   private void ShowIntervalDialog()
   {
      ...
      if(numintervals != oldIntervals)
      {
         ...
         Analysis.QuickLoad2(this, numintervals, intervalsize);
         if(data == null)
         {
            data = new GraphData(numintervals, intervalsize, filetype);
            setChildDatas();
         }   
         else
