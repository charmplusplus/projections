...
public class TimelineData
{
   ...
   {
      MyLinkedList tl, msglist;
      MyLinkedList packlist;
      TimelineEvent tle;
      ...
      for(int i=0; i<numItems; i++)
      {
         ...
         if(packlist == null)
            ...
            numpacks = packlist.length();
         
         PackTime[] packs = new PackTime[numpacks];
         for(int p=0; p<numpacks; p++)
         {
            packlist.next();
            packs[p] = (PackTime)packlist.data();
         }
