...
public final class RangeDialogNew extends JDialog
implements ActionListener, KeyListener, FocusListener, ItemListener
{
	 ...
	 *  
	 */
	public RangeDialogNew(ProjectionsWindow parentWindow, String titleString, RangeDialogExtensionPanel toolSpecificPanel, boolean disableRange)
	{
