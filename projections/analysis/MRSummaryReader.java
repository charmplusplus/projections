 ...
 *  3/27/2002
 *
 *  The MRSummaryReader reads .sum files to produce data to be consumed by
 *  the analyzer.
 */

public class MRSummaryReader
{
    // private static meta-tags
	...
	tokenizer=new StreamTokenizer(inFile);
