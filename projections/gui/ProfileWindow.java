...
{ 
   ...
   private void ShowDialog()
   {
	...
	public void MakePOArray(long bt, long et, Color[] colors)
	{
		setCursor(new Cursor(Cursor.WAIT_CURSOR));
		...
		int poNo=1;
		System.out.print("[");
		for (int p=0;p<data.plist.size();p++)
		{
			...
			//	System.out.println("Averaging in["+i+"]="+cur[i]+"% on #"+curPe);
   ...
   public void CloseDialog()
   {
      ...
      MakePOArray(data.begintime, data.endtime, colors);
   }     
